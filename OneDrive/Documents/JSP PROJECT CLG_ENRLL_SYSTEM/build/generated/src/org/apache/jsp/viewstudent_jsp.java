...
public final class viewstudent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('"');
      out.write('>');
      out.print(sb.getEnroll().length() > 10 ? sb.getEnroll().substring(0, 10) + "..." : sb.getEnroll() );
      out.write("</td>\n");
      out.write("            <td>");
      ...
      out.write('"');
      out.write('>');
      out.print(sb.getCourse().length() > 11 ? sb.getCourse().substring(0, 11) + "..." : sb.getCourse() );
      out.write("</td>\n");
      out.write("            <td title=\"");
      out.print(sb.getClg());
      out.write('"');
      out.write('>');
      out.print(sb.getClg().length() > 15 ? sb.getClg().substring(0, 15) + "..." : sb.getClg() );
      out.write("</td>\n");
      out.write("            <td>");
      ...
      out.write("    \n");
      out.write("    <div class=\"enroll-btn\">\n");
      out.write("        <button><a href=\"viewfaculty.jsp\">VIEW FACULTY DATA</a></button>\n");
      out.write("         \n");
      out.write("    </div>\n");
      out.write("    \n");
      out.write("    \n");
